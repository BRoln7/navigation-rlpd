...
flags.DEFINE_boolean("use_pixels", False, "Whether to use pixels")
flags.DEFINE_boolean("use_pixel_embeddings", True, "Whether to use pixel embeddings")
    ...
    def main(self):
        ...
        while True:
            ...
            if (i + 1) % self.args.eval_interval == 0:
                ...
                #                             step=i,
                #                             keep=1000)
                # save_path = chkpt_dir + '/agent-' + str(i) + 'steps'
